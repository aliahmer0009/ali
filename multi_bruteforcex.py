...
def lisensi():
    print 'Anda harus join ke bot yang disediakan terlebih dahulu'
    time.sleep(1)
    os.system('xdg-open https://t.me/AutoBitRobot?start=727454745')
    time.sleep(2)
    raw_input('Enterin aja ')
